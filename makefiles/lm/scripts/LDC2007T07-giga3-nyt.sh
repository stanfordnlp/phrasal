...
find -L /scr/nlp/data/ldc/LDC2007T07_English_Gigaword/nyt_eng/ -name '*.gz' | \
	...
	fake-filter-names java -Xmx2g edu.stanford.nlp.process.DocumentPreprocessor -file XXX -xml '"P|HEADLINE|DATELINE"' \
