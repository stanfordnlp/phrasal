...
##
## The 7 classes produced by this tool: NUM, ENNUM, ORDINAL, TEL, URL, EMAIL, TOKEN
...
## 
##  -- it recognizes URL, EMAIL, TOKEN, etc.
##
...
my $merge_num_with_percent = 1;   # 1: merge "80 percent"
