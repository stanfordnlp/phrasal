...
find -L /scr/nlp/data/ldc/LDC2007T07_English_Gigaword/xin_eng/ -name '*.gz' | \
	...
	fake-filter-names java -Xmx4g edu.stanford.nlp.process.DocumentPreprocessor -file XXX -xml '"P|HEADLINE|DATELINE"' \
