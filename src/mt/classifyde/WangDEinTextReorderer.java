  ...
  public static void main(String[] args) throws IOException {
    ...
    while((parsedSent=reader.next())!=null) {
      ...
      for (int deIdx : deIndices) {
        ...
        boolean toSwap = true;
        if (tag.equals("DEG")) {
          Tree leftTree = ExperimentUtils.getNPwithDE_leftTree(parsedSent, deIdx);
          // if the left label is null, it means there are more than one to the left of DE
          if (leftTree != null) {
            ...
            if (leftLabel.equals("ADJP") || leftLabel.equals("QP")) {
              ...
              if (leftTree.numChildren() == 1 && leftTree.firstChild().label().value().equals("PN")) {
