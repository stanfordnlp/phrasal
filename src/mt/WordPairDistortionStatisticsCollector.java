...
public class WordPairDistortionStatisticsCollector implements StatisticsCollector {
  ...
  public void collect(WordAlignment sent) {
    ...
    for(int curr=0; curr < f.size()-1; curr++) {
      ...
      */
      ...
      String distortionType = mt.ExperimentalFeaturizers.WordLevelDiscrimDistortionFeaturizer.getDistortionTypeAll(distance);
  ...
  public static void main(String[] args) {
    ...
    for(String distance : c.distortionTypeCounter.keySet()) {
      ...
      newDistortionTypeCounter.incrementCount(mt.ExperimentalFeaturizers.WordLevelDiscrimDistortionFeaturizer.getDistortionType(dis), count);
    }
