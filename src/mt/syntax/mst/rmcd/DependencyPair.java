...
public class DependencyPair {
  ...
  public boolean equals(Object o) {
    ...
    if(d1.i == last1 ^ d2.i == last2) return false;
    ...
    String[] cpos1 = i1.inBetweenPOS(i,j,true), cpos2 = i2.inBetweenPOS(i,j,true);
    if(!Arrays.equals(cpos1, cpos2)) return false;
    String[] pos1 = i1.inBetweenPOS(i,j,false), pos2 = i2.inBetweenPOS(i,j,false);
