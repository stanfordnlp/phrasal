...
import mt.train.CombinedFeatureExtractor;
import mt.train.SymmetricalWordAlignment;
import mt.train.WordAlignment;
import mt.train.AlignmentGrid.RelativePos;

/**
 * Extractor for lexicalized re-ordering probabilities of Moses, smoothed by POS
 * 
 * @author Pi-Chuan Chang
 * @author Michel Galley
 */
public class POSReorderingFeatureExtractor extends AbstractFeatureExtractor<String> {

  public static final String DEBUG_PROPERTY = "DebugPOSReorderingFeatureExtractor";
  ...
  public void init(Properties prop, Index featureIndex, AlignmentTemplates alTemps) {
    ...
    if(languageType != LanguageTypes.fe)
      throw new UnsupportedOperationException
       ("POSReorderingFeatureExtractor: model currently not supported.");
