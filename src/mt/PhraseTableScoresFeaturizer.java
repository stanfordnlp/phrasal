...
public class PhraseTableScoresFeaturizer<T> implements IncrementalFeaturizer<T,String>, IsolatedPhraseFeaturizer<T,String> {
	...
	/**
	 * @see mt.IncrementalFeaturizer#featurize(mt.Sequence, java.util.BitSet, java.util.BitSet)
	 */
	@Override
	...
	/**
	 * @see mt.IncrementalFeaturizer#listFeaturize(mt.Sequence, java.util.BitSet, java.util.BitSet)
	 */
