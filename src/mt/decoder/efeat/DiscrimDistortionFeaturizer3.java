...
public class DiscrimDistortionFeaturizer3 extends StatefulFeaturizer<IString,String> implements RichIncrementalFeaturizer<IString, String>{
...
//  private boolean USE_NULL = false;
  ...
  public DiscrimDistortionFeaturizer3(String... args) {
...
//    }
    ...
    //TODO WSGDEBUG: This was not present in the succesfull version...fix it?
//    numNullAlignments += (f.foreignPhrase.size() - alignedSToks.size());
  ...
  @Override
  public DiscrimDistortionFeaturizer3 clone() throws CloneNotSupportedException {
    return (DiscrimDistortionFeaturizer3) super.clone();
  }
