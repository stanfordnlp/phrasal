 ...
 *
 */
public class VerbLinkageFeaturizerCorpus implements IncrementalFeaturizer<IString, String> {
  ...
  public static final Set<String> tNouns = new HashSet<String>();
	...
	static {
      ...
      for (String line; (line = treader.readLine()) != null; ) {
          ...
          if (fields.length == 2 ){
          	...
          	if((fields[1].contains("PRP") && fields[1].startsWith("$")) || fields[1].startsWith("N") ){
          		tNouns.add(fields[0]);
          	}
          }
       }
      treader.close();
			...
			BufferedReader rreader = new BufferedReader(new FileReader(PATH_TO_LIST_OF_rule));
	...
	public List<FeatureValue<String>> listFeaturize(
		...
		String fCon= "" ;
		fCon = fConPVerb + fConPAdj + fConPNoun + fConPAdv + 
		       fConSVerb + fConSAdj + fConSNoun + 
		       fConLexP + "P" + fConLexS + "S" + 
		       fConPCross + fConSCross ;
