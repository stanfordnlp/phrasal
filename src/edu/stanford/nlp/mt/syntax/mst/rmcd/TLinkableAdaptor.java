 ...
 * therefore be extended trivially to create TLinkable objects without having to
 ...
 * @version $Id: TLinkableAdaptor.java,v 1.1 2001/11/15 17:09:54 jasonbaldridge
 *          Exp $
 * @see gnu.trove.TLinkedList
 */

public class TLinkableAdaptor<T extends TLinkableAdaptor<T>> implements
    TLinkable<T> {
