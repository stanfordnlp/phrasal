  ...
  public static void main(String args[]) throws Exception {
    ...
    for (int i = 0; i < runtimes; i++) {
      ...
      for (int testid = 0; testid < numsplits; testid++) {
        System.err
            .printf("  Using split %d/%d as test...\n", testid, numsplits);
    ...
    System.out
        .println("============================ 5class ============================");
    ClassifyingExperiment.displayEval(trainStats_5class, devStats_5class,
        testStats_5class);
    System.out
        .println("============================ 6class ============================");
    ClassifyingExperiment.displayEval(trainStats_6class, devStats_6class,
        testStats_6class);
    System.out
        .println("=========================== 2class ===========================");
    ClassifyingExperiment.displayEval(trainStats_2class, devStats_2class,
        testStats_2class);
  }
