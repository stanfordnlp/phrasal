...
public class LMServer {
  ...
  static double lm_ceiling_cost = 100;// TODO: make sure LMGrammar is using this
                                      // number
  static String remote_symbol_tbl = null;;

  // lm specific
  static String lm_file = null;
  static Double interpolation_weight = null;// the interpolation weight of this
                                            // lm
  ...
  public static void main(String[] args) {
    if (args.length != 1) {
      System.out
          .println("wrong command, correct command should be: java LMServer config_file");
    ...
    // String hostname=LMServer.findHostName();//this one is not stable,
    ...
    try {
      ...
      System.out
          .println("cannot create serversocket at port or connection fail");
      ioe.printStackTrace();
    } finally {
      try {
        serverSocket.close();
  ...
  public static class ClientHandler extends Thread {
    ...
    private String get_prob_backoff_state(DecodedStructure ds) {
      System.out
          .println("Error: call get_prob_backoff_state in lmserver, must exit");
      System.exit(0);
      return null;
      /*
    ...
    private String get_left_equiv_state(DecodedStructure ds) {
      System.out
          .println("Error: call get_left_equiv_state in lmserver, must exit");
      System.exit(0);
      return null;
    }
    ...
    private String get_right_equiv_state(DecodedStructure ds) {
      System.out
          .println("Error: call get_right_equiv_state in lmserver, must exit");
      System.exit(0);
      return null;
    }
