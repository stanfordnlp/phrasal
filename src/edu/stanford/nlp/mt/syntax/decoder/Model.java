...
public class Model {
   ...
   /*estimate depend only on the rule itself and the foreign sentence*/
	...
	public static class PhraseModel extends Model{
		/*the feature will be activated only when the owner is the same as the rule, 
		 * we need an owner to distinguish different feature in different phrase table/source*/
		int owner;
