...
public class ReorderRule {
  ...
  public String[] tgt_order = null;// a vector of string, we do not need
                                   // hiearchy of the target
  ...
  public ReorderRule(String rule_str) {
    ...
    tgt_order = fds[2].split("\\s+");// TODO: assume the chinese words does not
                                     // have x0, x1, and so on
  ...
  public boolean reorder(Tree.Node tree_node) {// tree_node: the node of the
                                               // parsing tree of the source
                                               // sentence
