...
public class Phrase implements Comparable<Object> {
   ...
   * behavior of the Comparable interface. Using this implementation, the
   * highest scoring phrase will appear at the head of a
  ...
  public boolean equals(Object other) {
    ...
    return (phrase.equals(otherPhrase.getPhrase())
        && fStart == otherPhrase.getStart() && fEnd == otherPhrase.getEnd());
  }
  ...
  public int hashCode() {
    ...
    final String hashString = Integer.toString(fStart) + phrase
        + Integer.toString(fEnd);
