...
/**
 * Analyzing how some Chinese words (given in "chWordList") are aligned to
 * English words in the f2e alignment
 * 
...
public class AnalyzeF2E {
  ...
  public static void main(String[] args) {
    ...
    try {
      feReader = new LineNumberReader(new InputStreamReader(
          new GZIPInputStream(new FileInputStream(feAlign))));
      efReader = new LineNumberReader(new InputStreamReader(
          new GZIPInputStream(new FileInputStream(efAlign))));
      chWordReader = new LineNumberReader(new InputStreamReader(
          (new FileInputStream(chWordList))));
      ...
      while (true) {
        ...
        GIZAWordAlignment sent = new GIZAWordAlignment(feLine1, feLine2,
            feLine3, efLine1, efLine2, efLine3);
