 ...
 * Does not try to build a tree using transitivity
 * 
 * @author Sebastian Schuster
 */
public class DependencyLanguageModelFeaturizer2 extends DerivationFeaturizer<IString, String> implements NeedsCloneable<IString, String> {
  ...
  public DependencyLanguageModelFeaturizer2() {
  
  }
  
  public DependencyLanguageModelFeaturizer2(String...args) throws IOException {
...
*/
  ...
  private Set<Integer> reachableNodes(int root) {
   return this.forwardDependencies.get(root) != null 
       ? this.forwardDependencies.get(root) : new TreeSet<Integer>();  
  }
