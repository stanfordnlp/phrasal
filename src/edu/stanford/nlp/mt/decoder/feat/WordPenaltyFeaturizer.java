...
public class WordPenaltyFeaturizer<TK> implements
	...
	public FeatureValue<String> featurize(Featurizable<TK, String> f) {
		...
		if (f.translatedPhrase == null) return new FeatureValue<String>(FEATURE_NAME, 0.0);
		return new FeatureValue<String>(FEATURE_NAME, MOSES_WORD_PENALTY_MUL*f.translatedPhrase.size());
	}
