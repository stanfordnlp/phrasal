 ...
 * plain text (not SGML!) files, for (a) the system output and (b) one reference
 * translation
 * 
 * Handy for the RTE MT evaluation stuff, since firing up TERtest for each and
 * every pair of segments takes forever
 * 
 * Supports the TERtest options for mangling the input file, but does not
 * support output, multiple references, translation spans etc.
 * 
 * @author pado
 * 
 */
...
public class TERsegmentwise {
   ...
   * 
   * @return double[] with TER scores. Currently, the number of edits and words
   *         are not returned
   */
  public static List<Double> segmentwiseTER(String hypFilename,
      String refFilename, TERcost costfunc) throws FileNotFoundException,
      IOException {
  ...
  public static void main(String[] args) throws IOException {
    ...
    HashMap<TERpara.OPTIONS, Object> paras = (HashMap<TERpara.OPTIONS, Object>) TERpara
        .getOpts(args);
