...
public class DependencyTreeBasedPreorderer {
...
//    features.add("HEAD-DEP:" + headWord.lemma());
//    //the children
//    int i = 0;
...
//      addWordFeature(features, child, child.lemma() + "-CHILD-" + i);
//      features.add("CHILD-" + i + "-DEP:" + child.lemma());
//
