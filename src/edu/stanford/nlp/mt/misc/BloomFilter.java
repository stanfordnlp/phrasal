...
import edu.stanford.nlp.mt.misc.BloomFilterStrategies.BitArray;
...
public final class BloomFilter<T> implements Serializable {
  ...
  @VisibleForTesting double computeExpectedFalsePositiveRate(long insertions) {
    return Math.pow(
  ...
  public static <T> BloomFilter<T> create(Funnel<T> funnel, long expectedInsertions /* n */,
     ...
     */
    long numBits = optimalNumOfBits(expectedInsertions, falsePositiveProbability);
