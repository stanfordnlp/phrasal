...
public final class MurmurHash3 {
  ...
  /** Returns the MurmurHash3_x86_32 hash. */
  public static int murmurhash3_x86_32(int[] data, int offset, int len, int seed) {

    final int c1 = 0xcc9e2d51;
    final int c2 = 0x1b873593;

    int h1 = seed;
    int roundedEnd = offset + len;  // round down to 4 byte block

    for (int i=offset; i<roundedEnd; i++) {
      // little endian load order
      int k1 = data[i];
      k1 *= c1;
      k1 = (k1 << 15) | (k1 >>> 17);  // ROTL32(k1,15);
