...
public class VerbPhraseBoundary {
  ...
  public void init(String sStr) {
    ...
    for (String span : spans) {
      ...
      if (phrasesBoundary.get(iq) != null)
        throw new RuntimeException("duplicate range");
      StringBuilder sb = new StringBuilder();
      sb.append(matcher.group(7)).append("-").append(matcher.group(5))
