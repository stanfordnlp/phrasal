...
public class AlignmentTemplate {
   ...
   */
  public AlignmentTemplate(String fStr, String eStr, String aStr, boolean lazy) throws IOException {
  ...
  public int getAKey() { return aKey; }

  public void setKey(int k) { key = k; }
  public void setEKey(int k) { eKey = k; }
  public void setFKey(int k) { fKey = k; }
  public void setAKey(int k) { aKey = k; }
}
