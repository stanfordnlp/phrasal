...
public class SoftPhraseExtractor extends AbstractPhraseExtractor {
  ...
  private static final boolean DISABLE_SHRINK = System
      .getProperty("disableShrink") != null;
  ...
  public SoftPhraseExtractor(Properties prop, AlignmentTemplates alTemps,
      List<AbstractFeatureExtractor> extractors) {
    super(prop, alTemps, extractors);
    System.err.println("Using experimental phrase extractor. Max crossings: "
        + maxCrossings);
  }
            ...
            // Grow block upwards:
            {
              ...
              for (int j = e2; j <= lastE2; ++j) {
                ...
                if (maxCrossings >= crossingsU && newPair(i, j)) {
                  ...
                  addPhraseToIndex(sent, f1, f2, i, j, crossingsU == 0,
                      expDecay(crossingsU));
                }
              }
            }
            ...
            if (maxCrossings > 0) {
              ...
              for (int j = e2; j >= mini; --j) {
                ...
                if (maxCrossings >= crossingsD && newPair(i, j)) {
                  ...
                  addPhraseToIndex(sent, f1, f2, i, j, false,
                      expDecay(crossingsD));
                }
              }
            }
