...
public class SymmetricalWordAlignment extends AbstractWordAlignment {
  ...
  protected void initSentPair(String fStr, String eStr) {
    ...
    f = new SimpleSequence<IString>(true, IStrings.toSyncIStringArray(preproc(fStr.split("\\s+"))));
    e = new SimpleSequence<IString>(true, IStrings.toSyncIStringArray(preproc(eStr.split("\\s+"))));
  }
