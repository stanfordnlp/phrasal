...
public abstract class AbstractFeatureExtractor implements FeatureExtractor {
   ...
   * @param featureIndex
   *          Index for feature names.
   * @param alTemps
   *          Set of all alignment templates seen so far in training data.
   */
   ...
   * the feature extractor. Unless this method is overridden, the default is 1.
   * 
   ...
   * 
   * @param currentPass
   *          current pass over training data
   */
  ...
  /**
   * By default, this class does not require an alignment grid for feature
   * extraction.
   */
  @Override
