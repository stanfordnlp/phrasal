...
public class Reports {
  ...
  public static void printAlignToFile(SentencePair sent, PrintStream of2,
      int[] viterbi_alignment, int pair_no, double alignment_score)
  ...
  // is connected to.
  {
    ...
    of2.println("# Sentence pair (" + pair_no + ") source length " + l
        + " target length " + m);
    for (int j = 1; j <= m; j++) {
