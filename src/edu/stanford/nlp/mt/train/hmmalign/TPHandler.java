...
/**
 * Writing separate classes to handle the translation probabilities with or
 * without tags; these classes take care of the caching and reduce the mess in
 * the em_loops in the models. Trying to obviate the need for too many different
 * em_loop methods
 * 
