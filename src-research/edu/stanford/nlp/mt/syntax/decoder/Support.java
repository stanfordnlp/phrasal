...
public class Support {
  ...
  public static int[] sub_int_array(int[] in, int start, int end) {// start:
                                                                   // inclusive;
                                                                   // end:
                                                                   // exclusive
  ...
  public static int[] sub_int_array(ArrayList in, int start, int end) {// start:
                                                                       // inclusive;
                                                                       // end:
                                                                       // exclusive
    int[] res = new int[end - start];
  ...
  public static long getMemoryUse() {
    putOutTheGarbage();
    long totalMemory = Runtime.getRuntime().totalMemory();// all the memory I
                                                          // get from the system
    putOutTheGarbage();
