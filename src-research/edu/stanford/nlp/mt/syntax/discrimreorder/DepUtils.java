...
public class DepUtils {
  public static void addPathsToMap(String path,
  ...
  public static String getPathName(int node1, int node2,
      TwoDimensionalMap<Integer, Integer, String> pathMap) {
    return pathMap.get(node1, node2);
  }

  static String getPathName(int node1, int node2, List<IndexedWord> list,
      SemanticGraph chGraph) {
    return getPathName(node1, node2, list, chGraph, false);
  }

  static String getPathName(int node1, int node2, List<IndexedWord> list,
      SemanticGraph chGraph, boolean useSameDirPath) {
