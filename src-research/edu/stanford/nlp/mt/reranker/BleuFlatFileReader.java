...
/**
 * Acts like multi-bleu.perl: Given an input file on stdin and a set of
...
public class BleuFlatFileReader {
  ...
  static Stats[] read(BufferedReader cin, BufferedReader[] rin)
      throws IOException {
    return read(cin, rin, new SegStatsFactory());
  }

  static Stats[] read(BufferedReader cin, BufferedReader[] rin, StatsFactory sf)
      throws IOException {
  ...
  public static void main(String[] args) throws IOException {
    ...
    System.out.printf("BLEU = %.2f, %.1f/%.1f/%.1f/%.1f (BP=%.3f)\n",
        ...
        Math.exp(ngramScores[3]) * 100.0, bleu.BP());
  }
}
