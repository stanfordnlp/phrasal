 ...
 * 
 */
public class VerbLinkageFeaturizer implements
    ...
    try {
      ...
      for (String line; (line = treader.readLine()) != null;) {
        ...
        if (fields.length == 2) {
          ...
          if (tag.contains("NN") || tag.contains("NNS") || tag.contains("NNP")
              || tag.contains("NNPS")) {
            tNounVerbs.add(fields[0]);
          }

          if (fields[0].equals("have") || fields[0].equals("had")
              || fields[0].equals("has")) {
            tHaveVerbs.add(fields[0]);
          }

          if (fields[0].equals("be") || fields[0].equals("is")
              || fields[0].equals("are") || fields[0].equals("am")
  ...
  public void initialize(List<ConcreteTranslationOption<IString>> options,
    ...
    for (IString fWord : previousForeign) {
      ...
      if (knownVerbs.contains(fWord.toString()))
        fExistVerbs.add(fWord.toString());
    }
  }
  ...
  public List<FeatureValue<String>> listFeaturize(
    ...
    for (int fPos = 0; fPos < fPhrSz; fPos++) {
      ...
      if (knownVerbs.contains(fWord)) {
        ...
        fCon = fEX + "_" + fverb + "_" + fVAverb + "_" + fnoun + "_" + fSHI
            + "_" + fYOU + "_" + fSHIi + "_" + fYOUi + "_" + fBPU + "_" + fnBPU
            + "_" + fDE + "_" + fAS + "_" + fAD;
        break;
      }
    }
    ...
    for (int tPos = 0; tPos < tPhrSz; tPos++) {
      ...
      if (tIngVerbs.contains(tWord.toString())
          || tWord.toString().endsWith("ing")) {
        tIngVerb = "t";
        tVerb = "t";
      }
      if (tEdVerbs.contains(tWord.toString())
          || tWord.toString().endsWith("ed")) {
        tEdVerb = "t";
        tVerb = "t";
      }
    ...
    String tCnd = "";
    tCnd = tBeVerb + "_" + tHaveVerb + "_" + tIngVerb + "_" + tEdVerb + "_"
        + tProtoVerb + "_" + tNounVerb + "_" + tRel + "_" + tConj + "_" + tTo
        + "_" + tIN;
