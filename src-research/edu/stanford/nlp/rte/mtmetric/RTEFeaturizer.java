...
public class RTEFeaturizer {
  ...
  public static double mtScore(String[] refs, String translation, Counter<String> wts) {
     int bestRef = 0;
  ...
  public static Counter<String> mtFeaturizer(String reference, String translation) {
