...
%  \item MERT introduced as improvement over log linear \cite{och2002b}
%  \begin{enumerate}
...
\caption{
\emcite{och2002b}'s line search method to find the global minimum in the loss, ${\ell}$, when starting at the point ${\bf w}$ and searching along the direction ${\bf d}$ using the candidate translations given in the collection of n-best lists ${\cal L}$.
...
%  \item describe method given in \cite{och2002b}, and 
...
%     \begin{enumerate}
%        \item original strategy suggested by \cite{och2002b}
