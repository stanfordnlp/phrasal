...
public class SegStatsTest extends TestCase {
  public void testSameSize2() {
    ...
    SegStats s = new SegStats(s1.length, r1.length, NGram.distribution(s1),
  ...
  public void testClipping() {
    ...
    s = new SegStats(s1.length, r1.length, NGram.distribution(s1),
        NGram.maxDistribution(new String[][] { r1, r2 }));
    assertEquals(2, s.correct[0]);
    assertEquals(3, s.total[0]);
  }
