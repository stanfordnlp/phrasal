  ...
  static {
	    ...
	    lm = (ARPALanguageModel) ARPALanguageModel.load("projects/mt/test/inputs/sampleLM.gz");
			featurizer = new NGramLanguageModelFeaturizer<IString>
			  (edu.stanford.nlp.mt.base.ARPALanguageModel.load("projects/mt/test/inputs/tinyLM.test"));
		} catch(IOException e) {
	...
	public void testConstructor4() throws IOException {
		NGramLanguageModelFeaturizer<IString> featurizer = 
		  new NGramLanguageModelFeaturizer<IString>("projects/mt/test/inputs/sampleLM.gz", "sampleLM");
		assertTrue(featurizer.order() == 3);      
		assertTrue(featurizer.lmOrder == 3);
	...
	public void testFromFile() throws IOException{
		featurizer = NGramLanguageModelFeaturizer.fromFile("projects/mt/test/inputs/sampleLM.gz", "sampleLM");      
		assertTrue(featurizer.order() == 3);      
		assertTrue(featurizer.lmOrder == 3);
	...
	public void testExceptionInConstructor4(String lmFile) throws IOException {
		new NGramLanguageModelFeaturizer<IString>("projects/mt/test/inputs/sampleLM.gz");
	}
	
	public void testExceptionInFromFile(NGramLanguageModelFeaturizer<IString> featurizer) throws IOException {
		featurizer = NGramLanguageModelFeaturizer.fromFile("projects/mt/test/inputs/sampleLM.gz");
	} 
