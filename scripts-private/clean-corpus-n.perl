#!/usr/bin/perl -w
#
# clean-corpus-n.perl - LGPL clean-corpus-n.perl 
# script taken from Moses
#
# Description: Filter the sentences in a bitext 
# so that they all fall within a given length range
